  ...
  return (
    <div className='pt-4 h-dvh'>
        <div className='px-[20px]'>
            <h1 className='font-sofia font-medium text-center text-[60px] lg:text-[72px] text-[#212529] leading-[75.21px] lg:pt-[130px] pb-2 tracking-[-1.21px]'>Your imagination, <span className='text-[#ED5729]'>Amplified</span>. Digitally.</h1>
