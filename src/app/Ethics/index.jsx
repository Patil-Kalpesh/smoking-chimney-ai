      ...
      <div className='container mx-auto px-[20px] py-[60px] '>
          ...
          <div className='pt-[38px] lg:px-[80px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-10 gap-y-10'>
              <div className="card-item lg:p-4 ">
                  <div className='h-[48px] w-[48px] '><img src="/images/Traced-icon-1.svg" alt="Traced" /></div>
              ...
              <div className="card-item lg:p-4 ">
                  <div className='h-[48px] w-[48px] '><img src="/images/Traced-icon-2.svg" alt="Traced" /></div>
              ...
              <div className="card-item lg:p-4 ">
                  <div className='h-[48px] w-[48px] '><img src="/images/Traced-icon-3.svg" alt="Traced" /></div>
              ...
              <div className="card-item lg:p-4 ">
                  <div className='h-[48px] w-[48px] '><img src="/images/Traced-icon-4.svg" alt="Traced" /></div>
              ...
              <div className="card-item lg:p-4 ">
                  <div className='h-[48px] w-[48px] '><img src="/images/Traced-icon-5.svg" alt="Traced" /></div>
              ...
              <div className="card-item lg:p-4 ">
                  <div className='h-[48px] w-[48px] '><img src="/images/Traced-icon-6.svg" alt="Traced" /></div>
              ...
              <div className="card-item lg:p-4 ">
                  <div className='h-[48px] w-[48px] '><img src="/images/Traced-icon-8.svg" alt="Traced" /></div>
              ...
              <div className="card-item lg:p-4 ">
                  <div className='h-[48px] w-[48px] '><img src="/images/Traced-icon-9.svg" alt="Traced" /></div>
              ...
              <div className="card-item lg:p-4 ">
                  <div className='h-[48px] w-[48px] '><img src="/images/Traced-icon-10.svg" alt="Traced" /></div>
